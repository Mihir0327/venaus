    ...
    <nav className="px-4 py-2   xl:px-[2.75rem] xl:py-[0.5rem] w-auto top-0 left-0  ">
      ...
      <div className="relative sm:px-6 lg:pl-[6rem]">
        <div className="flex items-center mr-2 justify-between">
            <div className="flex flex-shrink-0 items-center ">
              <a href="index.html" className=" "><img className="flex inset-x-0 left-0 h-14 md:h-14 lg:h-auto" src="image/logo.png" alt="" /></a>
          ...
          <div className=" items-center justify-end sm:items-stretch sm:justify-end">
            <div className="hidden  sm:ml-6 sm:block">
              <div className="flex whitespace-nowrap md:space-x-1 lg:space-x-3">
                ...
                <a href="#" className=" text-black-300 px-1 lg:px-3 font-[800] py-2 rounded-md text-sm " aria-current="page">Home</a>

                <a href="#" className="text-black-300 px-1 font-[800] lg:px-3 py-2 rounded-md text-sm ">About Us</a>
                ...
                <div className="mega-menu flex">
                  ...
                  {
                   showMenufurniture ? <div className="dropdwon-content container  w-[70%] bg-white absolute  top-20  left-[50%] -translate-x-[50%] z-[1]  rounded overflow-hidden">
                        ...
                        <ul>
                {
                  Menus.filter(i => i.megaMenu)[0].subMenu[selectMenu].content.map((data, index) => {
                    ...
                    return <li key={index} className="pl-6 xl:mb-[5px]">
                      <a href={data.url}
                        className="text-[8px] lg:text-[0.6rem] text-[#777777] font-[400]">{data.nameContent}
                      </a>
                    </li>
                ...
                <a href="#" className="text-black-300 font-[800] px-1 lg:px-4 py-2 rounded-md text-sm ">Interior Service</a>
                ...
                <a href="#" className="text-black-300 font-[800] px-1 lg:px-4 py-2 rounded-md text-sm ">Contact us</a>
      ...
      <div className=" w-full  rounded  shadow-lg ring-1 ring-black ring-opacity-5 sm:hidden relative" id="mobile-menu">
        {!open ? '' : <div className="space-y-1 px-2 pt-2 pb-3 absolute rounded-lg bg-[#f8f8f7] z-20 w-[100%] mt-3">
          <a href="#" className=" text-black-500 block px-3 py-2 rounded-md text-lg font-medium" aria-current="page">Home</a>
                          
          <a href="#" className="text-black-500  block px-3 py-2 rounded-md text-lg font-medium" >About Us</a>
          ...
          <a href="#" className="text-black-500  block px-3 py-2 rounded-md text-lg font-medium" >Interior Service</a>
          ...
          <a href="#" className="text-black-500  block px-3 py-2 rounded-md text-lg font-medium" >Contact us</a>
          <a href="/"
