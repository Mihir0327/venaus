                    ...
                    return <Carousel.Item key={index} interval={1000}  >
                        <div class="slide relative ">
                            ...
                            <div
                                ...
                                <div class="bold-title text-[15px] font-[500] mb-[10px] text-center md:text-[20px] md:mb-[15px] lg:text-[30px] lg:font-[600] lg:mb-[20px] ">
                                   {data.subTitle}
                                </div>
                                <div class="dis text-center text-[12px] sm:font[100]  md:font[200] md:text-[15px] lg:text-[18px] lg:font-[400]">
                                    <p>{data.describe}</p>
                                </div>
                            </div>
                        </div>
